...
@PipelineDecorator.pipeline(name="Train UI Detector", project="LVGL UI Detector", default_queue='training', pipeline_execution_queue='training')
def train_ui_detector(env: dict, dataset_id: str, model_variant: str = "yolov5n", **kwargs):
    ...
    # Train the model
    results = training_task(env, model_variant, dataset_id, args)
    return results
...
if __name__ == "__main__":
    ...
    train_ui_detector(env, dataset_id="60e9e9f4b2d3d6e3f3c8f8e7", model_variant="yolov5n")